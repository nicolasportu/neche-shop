...
const CartWidget = () => {
  const { calcItem } = useContext(CartContext)
  return (
    <Link to="/cart">
      <button className="boton-cart">{calcItem()}
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="cart">
